...
func (self *udpConnector) Start() cellnetEx.Peer {
...
func (self *udpConnector) Session() cellnetEx.Session {
...
func (self *udpConnector) connect() {
	...
	self.ProcEvent(&cellnetEx.RecvMsgEvent{ses, &cellnetEx.SessionConnected{}})
