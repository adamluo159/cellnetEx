...
func (TypeRPCHooker) OnInboundEvent(inputEvent cellnetEx.Event) (outputEvent cellnetEx.Event) {
...
func (TypeRPCHooker) OnOutboundEvent(inputEvent cellnetEx.Event) (outputEvent cellnetEx.Event) {
