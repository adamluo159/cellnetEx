...
func getPackageByCodecName(name string) string {
	switch name {
	case "gorillaws.ltv":
		return "github.com/adamluo159/cellnetEx/proc/gorillaws"
	case "http":
		return "github.com/adamluo159/cellnetEx/proc/http"
	case "tcp.ltv":
		return "github.com/adamluo159/cellnetEx/proc/tcp"
	case "udp.ltv":
		return "github.com/adamluo159/cellnetEx/proc/udp"
	default:
