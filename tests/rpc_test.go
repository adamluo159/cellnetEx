...
import (
	...
	"github.com/adamluo159/cellnetEx/proc/tcp"
...
func rpc_StartServer() {
	...
	proc.BindProcessorHandler(rpc_Acceptor, "tcp.ltv", func(ev cellnetEx.Event) {
...
func syncRPC_OnClientEvent(ev cellnetEx.Event) {
...
func asyncRPC_OnClientEvent(ev cellnetEx.Event) {
...
func typeRPC_OnClientEvent(ev cellnetEx.Event) {
...
func rpc_StartClient(eventFunc func(event cellnetEx.Event)) {
...
func init() {
	// 对TypeRPC增强
	proc.RegisterProcessor("tcp.ltv.type", func(bundle proc.ProcessorBundle, userCallback cellnetEx.EventCallback, args ...interface{}) {
