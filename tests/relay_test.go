...
var (
	...
	relay_ClientToAgentAcceptor   cellnetEx.Peer
	relay_BackendToAgentConnector cellnetEx.Peer
	relay_BackendToAgentAcceptor  cellnetEx.Peer
	relay_Client                  cellnetEx.Peer
)
...
func relay_backend() {
	...
	proc.BindProcessorHandler(relay_BackendToAgentConnector, "tcp.ltv", func(ev cellnetEx.Event) {
...
func relay_agent() {
	...
	var backendSession cellnetEx.Session
	...
	backendToAgentDispatcher.RegisterMessage("cellnetEx.SessionAccepted", func(ev cellnetEx.Event) {
	...
	ClientToAgentDispatcher.RegisterMessage("tests.TestEchoACK", func(ev cellnetEx.Event) {
	...
	relay.SetBroadcaster(func(event *relay.RecvMsgEvent) {
		...
		if event.Ses.Peer() == relay_BackendToAgentAcceptor {
			...
			// 广播器
			sesAccessor := relay_ClientToAgentAcceptor.(cellnetEx.SessionAccessor)
...
func relay_client() {
	...
	proc.BindProcessorHandler(relay_Client, "tcp.ltv", func(ev cellnetEx.Event) {
