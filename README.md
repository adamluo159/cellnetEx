...
[1]: https://godoc.org/github.com/davyxu/cellnetEx?status.svg
[2]: https://godoc.org/github.com/davyxu/cellnetEx
[3]: https://travis-ci.org/davyxu/cellnetEx.svg?branch=master
[4]: https://travis-ci.org/davyxu/cellnetEx
[5]: https://goreportcard.com/badge/github.com/davyxu/cellnetEx
[6]: https://goreportcard.com/report/github.com/davyxu/cellnetEx
...
```
  go get -u -v github.com/davyxu/cellnetEx
...
cellnetEx 使用Protobuf时，需要使用附带的pb插件生成一个绑定代码，下面的链接可以处理这个问题
[Google Protobuf 编码安装](https://github.com/davyxu/cellnetEx/blob/master/doc/pbcodec.md)
...
func server() {
	...
	proc.BindProcessorHandler(peerIns, "tcp.ltv", func(ev cellnetEx.Event) {
		...
		case *cellnetEx.SessionAccepted: // 接受一个连接
		...
		case *cellnetEx.SessionClosed: // 会话连接断开
...
[目录及功能一览](https://github.com/davyxu/cellnetEx/blob/master/doc/dirstruct.md)
...
那么 cellnet结构位于 /home/you/go/src/github.com/davyxu/cellnetEx
...
* [队列](https://github.com/davyxu/cellnetEx/blob/master/doc/queue.md)

* [端(Peer)](https://github.com/davyxu/cellnetEx/blob/master/doc/peer.md)

* [收发处理消息](https://github.com/davyxu/cellnetEx/blob/master/doc/procmsg.md)
...
* [定制封包编码(Codec)](https://github.com/davyxu/cellnetEx/blob/master/doc/customcodec.md)

    封包编码可以是JSON，Protobuf等

* [定制端(Peer)](https://github.com/davyxu/cellnetEx/blob/master/doc/custompeer.md)

    新增Redis连接器，与cellnet自带的TCP/UDP的Peer都不同。

* [定制处理器(Processor)](https://github.com/davyxu/cellnetEx/blob/master/doc/customproc.md)

    需要在收发包时有统一的处理行为

# FAQ

[常见问题及回答](https://github.com/davyxu/cellnetEx/blob/master/doc/faq.md)
...
# 版本历史
2018.5  v4版本 [详细请查看](https://github.com/davyxu/cellnetEx/blob/v4/CHANGES.md)

2017.8  v3版本 [详细请查看](https://github.com/davyxu/cellnetEx/blob/v3/CHANGES.md)

2017.1  v2版本 [详细请查看](https://github.com/davyxu/cellnetEx/blob/v2/CHANGES.md)
...
提交bug及特性: https://github.com/davyxu/cellnetEx/issues
